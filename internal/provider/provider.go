...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-routing/internal/eda/utils"
...
var _ provider.Provider = (*routingProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &routingProvider{version: ver}
	}
}
...
func (p *routingProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *routingProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *routingProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "routing-v1alpha1"
	resp.Version = p.version
}

func (p *routingProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewAttachmentLookupDataSource,
		NewAttachmentLookupListDataSource,
		NewDefaultInterfaceDataSource,
		NewDefaultInterfaceListDataSource,
		NewDefaultRouterDataSource,
		NewDefaultRouterListDataSource,
		NewDrainDataSource,
		NewDrainListDataSource,
		NewResourceListDataSource,
		NewRouteLookupDataSource,
		NewRouteLookupListDataSource,
		NewRouteTraceDataSource,
...
func (p *routingProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewAttachmentLookupResource,
		NewDefaultInterfaceResource,
		NewDefaultRouterResource,
		NewDrainResource,
