...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-routing/internal/resource_drain"
	"github.com/nokia/eda/apps/terraform-provider-routing/internal/tfutils"
)

const (
	create_rs_drain = "/apps/routing.eda.nokia.com/v1alpha1/namespaces/{namespace}/drains"
	read_rs_drain   = "/apps/routing.eda.nokia.com/v1alpha1/namespaces/{namespace}/drains/{name}"
	update_rs_drain = "/apps/routing.eda.nokia.com/v1alpha1/namespaces/{namespace}/drains/{name}"
	delete_rs_drain = "/apps/routing.eda.nokia.com/v1alpha1/namespaces/{namespace}/drains/{name}"
)
...
func (r *drainResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_drain.DrainResourceSchema(ctx)
}

func (r *drainResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_drain.DrainModel
	...
	err = r.client.Create(ctx, create_rs_drain, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_drain, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
...
func (r *drainResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_drain, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *drainResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_drain, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
