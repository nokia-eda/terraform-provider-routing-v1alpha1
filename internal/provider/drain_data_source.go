...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-routing/internal/datasource_drain"
...
const read_ds_drain = "/apps/routing.eda.nokia.com/v1alpha1/namespaces/{namespace}/drains/{name}"

var (
	_ datasource.DataSource              = (*drainDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*drainDataSource)(nil)
)
...
func (d *drainDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = datasource_drain.DrainDataSourceSchema(ctx)
}

func (d *drainDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_drain.DrainModel
	...
	err = d.client.GetByQuery(ctx, read_ds_drain, map[string]string{
...
func (r *drainDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
