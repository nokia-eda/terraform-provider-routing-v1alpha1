...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-routing/internal/datasource_route_lookup"
...
const read_ds_routeLookup = "/workflows/v1/routing.eda.nokia.com/v1alpha1/namespaces/{namespace}/routelookups/{name}"

var (
	_ datasource.DataSource              = (*routeLookupDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*routeLookupDataSource)(nil)
)
...
func (d *routeLookupDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = datasource_route_lookup.RouteLookupDataSourceSchema(ctx)
}

func (d *routeLookupDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_route_lookup.RouteLookupModel
	...
	err = d.client.GetByQuery(ctx, read_ds_routeLookup, map[string]string{
...
func (r *routeLookupDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
