...
package datasource_attachment_lookup_list
...
func AttachmentLookupListDataSourceSchema(ctx context.Context) schema.Schema {
...
type AttachmentLookupListModel struct {
