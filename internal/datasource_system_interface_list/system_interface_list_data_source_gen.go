...
package datasource_system_interface_list
...
func SystemInterfaceListDataSourceSchema(ctx context.Context) schema.Schema {
...
type SystemInterfaceListModel struct {
